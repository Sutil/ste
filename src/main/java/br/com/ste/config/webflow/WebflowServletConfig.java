package br.com.ste.config.webflow;
...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = "br.com.ste.app", scopedProxy = ScopedProxyMode.TARGET_CLASS, useDefaultFilters = false, includeFilters = {
